...
@DataSetConfiguration(dbunitProperties = "dbunit.properties", insertDatasets = "target/test-classes/insert-data.xml", deleteAllDataSets = "target/test-classes/delete-data.xml")
@DataSourceConfiguration(jdbcPropertiesFile = "jdbc.properties")
public class VitUnitInsertAndDeleteDataTestCase extends VitUnitTestCase {
	...
	try {
	    ...
	    PreparedStatement prepareStatement = connection
		    .prepareStatement("select * from tbl_data_sets where id = -1");
