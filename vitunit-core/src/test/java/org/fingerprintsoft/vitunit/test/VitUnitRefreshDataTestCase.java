...
@DataSetConfiguration(dbunitProperties = "dbunit.properties", refreshDatasets = "target/test-classes/refresh-data.xml", deleteAllDataSets = "target/test-classes/delete-data.xml")
@DataSourceConfiguration(jdbcPropertiesFile = "jdbc.properties")
public class VitUnitRefreshDataTestCase extends VitUnitTestCase {
	...
	try {
	    ...
	    PreparedStatement prepareStatement = connection
		    .prepareStatement("select * from tbl_data_sets where id = -2");
