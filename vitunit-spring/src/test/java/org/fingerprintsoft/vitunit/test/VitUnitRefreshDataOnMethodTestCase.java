...
public class VitUnitRefreshDataOnMethodTestCase extends VitUnitTestCase {

    @Test
    @DataSetConfiguration(refreshDatasets = "target/test-classes/refresh-data.xml", deleteAllDataSets = "target/test-classes/delete-data.xml")
