...
public class VitUnitInsertAndDeleteDataOnMethodTestCase extends VitUnitTestCase {

    @Test
    @DataSetConfiguration(insertDatasets = "target/test-classes/insert-data.xml", deleteAllDataSets = "target/test-classes/delete-data.xml")
